...
class AppController(QObject):
    ...
    async def open_file_and_load(self):
        ...
        try:
            ...
            logging.error(f"Error in open_file_and_load: {e}")
            traceback.print_exc()
    ...
    async def process_file(self, file_path: str):
        try:
            ...
            # Appelez load_parsed_blast_hits sans progress_callback
            parsed_results = await asyncio.to_thread(load_parsed_blast_hits, file_path)
    ...
    def show_results(self, data, file_path: str):
        ...
        self.results_widget = DynamicTableWindow(data,file_path) # Create a table window
